...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'BluePrint3D',
        short_name: 'BluePrint3D',
        description: 'Scan 2D construction prints and turn them into interactive 3D models',
        theme_color: '#0f172a',
      ...
      workbox: {
        // Generous max so the wasm + pdf.js bundles get precached for offline use
